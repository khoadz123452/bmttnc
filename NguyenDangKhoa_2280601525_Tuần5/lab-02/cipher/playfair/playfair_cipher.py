class PlayFairCipher:
    ...
    # The second __init__ method is redundant and likely a typo.
    # It has been removed.
    ...
    def playfair_decrypt(self, cipher_text, matrix):
        ...
        decrypted_text = ""
        # decrypted_text1 is declared but not used, can be removed if not needed.
        # decrypted_text1 = "" 
            ...
            if row1 == row2:
                ...
                decrypted_text += matrix[(row1 - 1) % \
                                         5][col1] + matrix[(row2 - 1) % \
                                                          5][col2]
            else: # This 'else' block was misplaced in your original input.
